...
**6个核心工作流别名** (定义在 `~/.zshrc`):
```bash
alias claude="/Volumes/1TB-M2/openclaw/claude-code-setup/claude-dual-model.sh"        # 交互选择-灵活切换所有模型
alias claude-max="/Volumes/1TB-M2/openclaw/claude-code-setup/claude-qwen-alt.sh -m qwen3.6-plus"  # Qwen3.6-Max替代方案
alias claude-dev="/Volumes/1TB-M2/openclaw/claude-code-setup/claude-dual-model.sh 2"  # DeepSeek R1-新功能开发
alias claude-fix="/Volumes/1TB-M2/openclaw/claude-code-setup/claude-dual-model.sh 1"  # DeepSeek Chat-Bug修复
alias claude-zh="/Volumes/1TB-M2/openclaw/claude-code-setup/claude-qwen-alt.sh"       # Qwen3.6-Plus-中文项目
alias claude-init='eval "$(/Volumes/1TB-M2/openclaw/claude-code-setup/init-claude-env.sh --export)"'  # 环境初始化
```
