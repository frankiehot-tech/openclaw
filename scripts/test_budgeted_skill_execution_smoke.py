...
def test_setup():
    ...
    # 检查模块是否可用
    try:
        from mini_agent.agent.core.budget_engine import BudgetEngine, get_budget_engine
        from mini_agent.agent.core.skill_cost_estimator import (
            SkillCostEstimator,
            get_cost_estimator,
        )
        ...
        from mini_agent.agent.core.skill_registry import SkillRegistry, get_registry
