#!/usr/bin/env python3
"""Dedicated Codex review runner for Athena AI plan queues."""
...
PID_FILE = pid_file("codex_review_runner")
ACCEPTED_RUNNER_MODES = {"codex_review", "manual_review"}


def main() -> int:
    parser = argparse.ArgumentParser(description="Athena Codex review queue runner")
    parser.add_argument(
        "command",
        nargs="?",
        default="daemon",
    ...
    if args.command == "daemon":
        return daemon_mode(
            ...
            pid_file=PID_FILE,
            runner_name="codex_review_runner",
        )
