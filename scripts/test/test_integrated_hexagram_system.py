...
from enhanced_hetu_luoshu_scheduler import HexagramEnhancedLuoshuScheduler  # noqa: E402
from mini_agent.agent.core.maref_quality.hetu_luoshu_scheduler import (  # noqa: E402
    AssessmentPriority,
)
...
def test_performance_benchmark():
    ...
    try:
        # 创建调度器（设置高并发限制以避免等待）
        scheduler = HexagramEnhancedLuoshuScheduler(state_file=state_file, max_concurrent=20)
        ...
        for task_id in task_ids:
            _ = scheduler.get_task_status(task_id)
